...
$.ajax({
  ...
  var UVqueryURL = "http://api.openweathermap.org/data/2.5/uvi?lat=" + cityLatitude + "&lon=" + cityLongitude + "&appid=0d2df46fe7ac45114da1797fcf89227a";
 $.ajax ({
     url: UVqueryURL,
     method: "GET"
 }).then (function (response) {
...
for (i=0 ; i<5 ; i++) {
  ...
  h3El.text(month + "/" + (day + (i+1)) + "/" + year).addClass("col-2 img-thumbnail");
